      ...
      if($num>0)
      {
       $json = ['success' => true,];
        while($arr = mysqli_fetch_assoc($sel))
        {
          ...
          // print_r($expData);
          // die;
          $json['Sale'][] =['Agent Name'=>$aName, 'Product Receive' =>$pReceive, 'Receive Time'=>$rTime, 'Product Return'=>$pReturn, 'Sale Product'=>$pSale, 'Quantity'=>$pSaleQauntity, 'Sale Time'=>$pSaleTime];
